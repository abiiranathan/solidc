...
TEST(StringTest, TestRegexCapture) {
    ...
    char** sub_matches = regex_capture(str, regex, num_capture_groups, &num_matches);
    ...
    char** sub_matches2 = regex_capture(str2, regex2, num_capture_groups, &num_matches);
...
TEST(StringTest, TestJaroDistance) {
    ...
    EXPECT_NEAR(string_jaro_distance("JELLYFISH", "SMELLYFISH"), 0.89629632, 1e-4);
}
