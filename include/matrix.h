...
static inline bool mat4_equal(Mat4 a, Mat4 b) {
    ...
    return simd_equals_eps(a.cols[0], b.cols[0], EPSILON) &&
           simd_equals_eps(a.cols[1], b.cols[1], EPSILON) &&
           simd_equals_eps(a.cols[2], b.cols[2], EPSILON) &&
           simd_equals_eps(a.cols[3], b.cols[3], EPSILON);
}
...
static inline float mat4_determinant(Mat4 m) {
    ...
    float det = m00 * (m11 * (m22 * m33 - m32 * m23) - m21 * (m12 * m33 - m32 * m13) +
                       m31 * (m12 * m23 - m22 * m13)) -
                m10 * (m01 * (m22 * m33 - m32 * m23) - m21 * (m02 * m33 - m32 * m03) +
                       m31 * (m02 * m23 - m22 * m03)) +
                m20 * (m01 * (m12 * m33 - m32 * m13) - m11 * (m02 * m33 - m32 * m03) +
                       m31 * (m02 * m13 - m12 * m03)) -
                m30 * (m01 * (m12 * m23 - m22 * m13) - m11 * (m02 * m23 - m22 * m03) +
                       m21 * (m02 * m13 - m12 * m03));
...
static inline Mat4 mat4_inverse(Mat4 m) {
    ...
    // Inverse Column 0
    simd_vec_t col0 =
        simd_set((m11 * Fac0 - m12 * Fac1 + m13 * Fac2), -(m10 * Fac0 - m12 * Fac3 + m13 * Fac4),
                 (m10 * Fac1 - m11 * Fac3 + m13 * Fac5), -(m10 * Fac2 - m11 * Fac4 + m12 * Fac5));

    // Inverse Column 1
    simd_vec_t col1 =
        simd_set(-(m01 * Fac0 - m02 * Fac1 + m03 * Fac2), (m00 * Fac0 - m02 * Fac3 + m03 * Fac4),
                 -(m00 * Fac1 - m01 * Fac3 + m03 * Fac5), (m00 * Fac2 - m01 * Fac4 + m02 * Fac5));

    // Inverse Column 2
    simd_vec_t col2 =
        simd_set((m31 * Fac6 - m32 * Fac7 + m33 * Fac8), -(m30 * Fac6 - m32 * Fac9 + m33 * Fac10),
                 (m30 * Fac7 - m31 * Fac9 + m33 * Fac11), -(m30 * Fac8 - m31 * Fac10 + m32 * Fac11));

    // Inverse Column 3
    simd_vec_t col3 =
        simd_set(-(m21 * Fac6 - m22 * Fac7 + m23 * Fac8), (m20 * Fac6 - m22 * Fac9 + m23 * Fac10),
