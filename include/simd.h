...
#else
    return (simd_vec_t){
        {1.0f / sqrtf(v.f[0]), 1.0f / sqrtf(v.f[1]), 1.0f / sqrtf(v.f[2]), 1.0f / sqrtf(v.f[3])}};
#endif
}
...
#else
    return fabsf(a.f[0] - b.f[0]) < epsilon && fabsf(a.f[1] - b.f[1]) < epsilon &&
           fabsf(a.f[2] - b.f[2]) < epsilon && fabsf(a.f[3] - b.f[3]) < epsilon;
#endif
}
