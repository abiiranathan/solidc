...
#define DEFINE_SET(T)                                                                                \
    ...
    /* Add element to the set. returns true if added successfully or already exists. */              \
    ...
    /* Computes the union of two sets A and B, and returns a new set containing all elements in A  \
     * and B. */ \
    ...
    /* Computes the intersection of two sets A and B, and returns a new set containing elements    \
    ...
    /* Computes the difference of two sets A and B, and returns a new set containing elements that \
    ...
    /* Computes the symmetric difference of two sets A and B, and returns a new set containing     \
    ...
    /* Determines if setA is a subset of setB, and returns true if all elements in setA are also   \
     * in setB.*/ \
    ...
    /* Determines if setA is a proper subset of setB, and returns true if all elements in setA are \
