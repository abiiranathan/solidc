...
typedef struct list_node {
    ...
    /** Pointer to the previous node in the list. nullptr if this is the head. */
...
typedef struct {
    ...
    list_node_t* head;
    /** Pointer to the last node in the list. nullptr if empty. */
    list_node_t* tail;
 ...
 * @param list Pointer to the list. Must not be nullptr.
 * @param elem Pointer to the element data to remove. Must not be nullptr.
