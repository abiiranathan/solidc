...
typedef struct slist_node {
    ...
    void* data;
    /** Pointer to the next node in the list. nullptr if this is the tail. */
 ...
 */
typedef struct {
    /** Pointer to the first node in the list. nullptr if empty. */
    slist_node_t* head;
    /** Pointer to the last node in the list for O(1) append. nullptr if empty. */
    slist_node_t* tail;
 ...
 * @return Pointer to newly allocated list on success, nullptr on allocation failure.
 ...
 * @param list Pointer to the list to free. Safe to pass nullptr.
 */
void slist_free(slist* list);

/**
 * Returns the number of elements in the list.
 * @param list Pointer to the list. Must not be nullptr.
 ...
 * @param list Pointer to the list to clear. Must not be nullptr.
 */
 ...
 * @param data Pointer to the element data to copy into the node. Must not be nullptr.
 * @return Pointer to newly allocated node on success, nullptr on allocation failure.
 ...
 * @param node Pointer to the node to free. Safe to pass nullptr.
 */
 ...
 * @param list Pointer to the list. Must not be nullptr.
 * @param elem Pointer to the element data to insert. Must not be nullptr.
 */
 ...
 * @param list Pointer to the list. Must not be nullptr.
 * @param elem Pointer to the element data to append. Must not be nullptr.
 */
 ...
 * @return Pointer to the element data on success, nullptr if index is out of bounds.
 ...
 * @param list Pointer to the list. Must not be nullptr.
 * @param elem Pointer to the element data to find. Must not be nullptr.
 ...
 * @param list Pointer to the list. Must not be nullptr.
 * @param elem Pointer to the element data to insert. Must not be nullptr.
 * @param after Pointer to the element data after which to insert. Must not be nullptr.
 ...
 * @param list Pointer to the list. Must not be nullptr.
 * @param elem Pointer to the element data to insert. Must not be nullptr.
 * @param before Pointer to the element data before which to insert. Must not be nullptr.
